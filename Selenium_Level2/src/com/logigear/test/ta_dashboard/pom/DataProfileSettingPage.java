...
public class DataProfileSettingPage extends GeneralPage{
	...
	public DataProfileSettingPage() {
		super(DataProfileSettingPage.class);
	}
	...
	public DataProfileSettingPage selectSetting(String option) {
